    ...
    <div class="personnel">
      <div class="personnelContent">
       ...
       <div class="editProp">
          ...
          <el-form-item label="考核模板：">
             <el-select v-model="editFromLabel.region" placeholder="请选择模板" style="width: 100%;">
          ...
          <el-form-item label="考核时间：">
             <el-col :span="11">
                <el-date-picker type="date" placeholder="开始时间" v-model="editFromLabel.date1" style="width: 100%;"></el-date-picker>
              </el-col>
              <el-col class="line" :span="2">-</el-col>
              <el-col :span="11">
                <el-date-picker type="date" placeholder="结束时间" v-model="editFromLabel.date2" style="width: 100%;"></el-date-picker>
              </el-col>
          </el-form-item>
          <el-form-item label="考核周期：">
             <el-select v-model="editFromLabel.cycle" placeholder="请选择周期" style="width: 100%;">
          ...
          <el-form-item label="考核对象：">
              <el-select v-model="editFromLabel.objects" multiple placeholder="请选择" style="width: 100%;">
                <el-option
